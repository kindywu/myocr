...
药品信息录入系统是一款移动端优先的 Web 应用，帮助药店工作人员或医护人员通过拍照识别和手动输入两种方式快速、准确地录入药品信息（名称、有效期、生产厂家、批号等）。
